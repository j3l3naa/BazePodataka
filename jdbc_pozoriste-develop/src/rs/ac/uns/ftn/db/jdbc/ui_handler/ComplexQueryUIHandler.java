	...
	public void handleComplexQueryMenu() {
		...
		do {
			...
			case "5":
				...
				break;
			case "6":
				complexQueryService.showActorsWithMaxHon();
				break;
			case "7":
				// TODO implementirati
			...
			case "8":
				...
				break;
			case "9":
				complexQueryService.showActorsPartInRole();
				break;
			case "10":
				complexQueryService.showActorsWithMoreThanAverage();
				break;
			case "11":
				complexQueryService.showComplexQueryZad11();
				break;
			case "12":
				complexQueryService.oldPeople();
				break;
			case "13":
				complexQueryService.addTheatreByWish();
				break;
