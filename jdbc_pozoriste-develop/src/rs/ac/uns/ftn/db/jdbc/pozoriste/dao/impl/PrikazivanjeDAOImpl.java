...
public class PrikazivanjeDAOImpl implements PrikazivanjeDAO {
	...
	public void delete(Prikazivanje entity) throws SQLException {
		...
		try (Connection connection = ConnectionUtil_HikariCP.getConnection(); 
			...
			preparedStatement.setInt(1, entity.getRbr());
	...
	public void deleteAll() throws SQLException {
		// TODO Auto-generated method stub
		String query = "delete from prikazivanje";
	...
	public boolean existsById(Integer id) throws SQLException {
		...
		String query = "select * from prikazivanje where rbr = ?";
	...
	public Iterable<Prikazivanje> findAllById(Iterable<Integer> ids) throws SQLException {
		// TODO Auto-generated method stub
		String query = "select rbr, datumpri, vremepri, brojgled, idpred, idsce from prikazivanje where rbr in (";
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(query);
		
		List<Prikazivanje> prikazivanja = new ArrayList<Prikazivanje>();
		...
		try (Connection connection = ConnectionUtil_HikariCP.getConnection();
			...
			try (ResultSet resultSet = preparedStatement.executeQuery()) {
				while(resultSet.next()) {
					prikazivanja.add(new Prikazivanje(resultSet.getInt(1), resultSet.getDate(2), resultSet.getDate(3), resultSet.getInt(4), resultSet.getInt(5), resultSet.getInt(6)));
				}
			}
		}
		return prikazivanja;
