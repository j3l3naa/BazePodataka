...
public class Uloga {
	...
	public Uloga(int idulo, String imeulo, String pol, String vrstaulo, int idpred) {
		this.idulo = idulo;
		this.imeulo = imeulo;
		this.pol = pol;
	...
	public void setIdulo(int idulo) {
		this.idulo = idulo;
	}
	...
	public String toString() {
		return String.format("%4d %-10s %-10s %-10s %-10d", idulo, imeulo, pol, vrstaulo, idpred);
	}
	
	public static String getFormattedHeader() {
		return String.format("%-4s %-10s %-10s %-10s %-10s", "IDULO", "IME", "POL", "VRSTA", "IDPRED");
	}
